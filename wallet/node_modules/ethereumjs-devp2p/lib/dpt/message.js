...
const keccak256 = _require.keccak256,
      int2buffer = _require.int2buffer,
      buffer2int = _require.buffer2int,
      assertEq = _require.assertEq;
...
const timestamp = {
  encode: function encode(value = getTimestamp() + 60) {
...
const endpoint = {
  ...
  decode: function decode(payload) {
    return {
