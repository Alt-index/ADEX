...
contract ADEX is Ownable {
  ...
  mapping(address => uint256) requestWithdraws;
 ...
 event Approval(address indexed owner, address indexed spender, uint256 value);
  ...
  function decreaseApproval(address _spender, uint _subtractedValue) public returns (bool) {
    ...
    address public ADEXAddr = 0xa9a3027bf228f1E85385BF06b4Db0eF62c66c14C;

    //Declare logging events
    event LogDeposit(address sender, uint amount);

    /* Initializes contract with initial supply tokens to the creator of the contract */
    function ADEX(uint256 initialSupply, string tokenName, string tokenSymbol) public {
    ...
    function setReward(uint256 _value) public{
